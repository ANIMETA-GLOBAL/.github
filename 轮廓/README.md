...
###### ANIMETA 是一个为用户提供高流动性的综合性NFT 服务平台。它具有四大功能：NFT Primary、NFT market、Farm 和My NFT。用户可以自由创建和交易NFT，并可享受首发NFT、抢购盲盒、挖矿等高级服务。未来，ANIMeta 将首发预售NFT 盲盒或NFT 挖矿等，为用户提供更多的玩法。
...
###### 创建系列时可以填写1—10%之间的版税，系列中的NFT只要在该平台中交易一次就会获得一笔版税，版税根据成交额算。创建系列需要选择链以及币种。如果您想要创建自己的专属NFT，ANIMETA市场是一个绝佳的选择。您只需填写NFT的详细信息、上传数字艺术品或文件。如需出售NFT，也可以将其快速投放到NFT市场。在创建专属NFT之前，您需要准备：您的艺术品或收藏品图片储蓄数字货币的数字货币钱包给您作品取上一个响亮的名字在我们平台您需要连接您的数字钱包，我们推荐使用「Metamask」。
##### 如何导入NFT?
